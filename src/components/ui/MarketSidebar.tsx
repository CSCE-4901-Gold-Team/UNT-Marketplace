...
export default function MarketSidebar({
    ...
    return (
        <div id="marketSidebar" className={sidebarClassList}>
            <div className="h-screen flex flex-col gap-6 py-6 w-full bg-linear-to-b from-gray-100 to-gray-200 shadow-2xl transition-all">
                <button className="absolute top-2 right-3 text-4xl bg-green text-gray-100 rounded-full lg:hidden hover:bg-green-700 transition-colors"
                    onClick={() => setShowSidebarAction(false)}>
                    <IoMdCloseCircle />
                </button>

                {/* Sidebar Logo */}
                <div id="marketSidebarLogo" className="bg-linear-to-r from-green-600 to-green-700 text-gray-100 p-5 px-4 shadow-lg -me-2 rounded-r-2xl">
                ...
                {/* MARKETPLACE SECTION */}
                <div id="marketSidebarTopMenu" className="flex flex-col gap-2 px-4">
                    <div className="flex items-center justify-between px-2 mb-1">
                        <div className="text-base font-black text-gray-500 uppercase tracking-wider">Marketplace</div>
                        <Link href="/profile" className="no-underline">
                            <button className="p-1.5 rounded-full hover:bg-gray-200 transition-colors" aria-label="Account settings">
                    ...
                    <div className="flex flex-col gap-2 font-bold text-base text-gray-700">
                ...
                {/* ACCOUNT SECTION */}
                <div id="marketSidebarBottomMenu" className="mt-auto flex flex-col gap-2 px-4 font-bold text-gray-700">
                    <div className="border-t border-gray-300 pt-4 pb-2">
                        <div className="text-base font-bold text-gray-500 px-2 mb-3 uppercase tracking-wider">Account</div>
