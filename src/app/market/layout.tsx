...
export default async function MarketLayout({
  ...
  return (
    <div id="marketContainer" className="flex min-h-screen items-stretch bg-white">
      ...
      {/* Sidebar */}
      <div id="marketSidebar" className="flex flex-col w-64">
        <div className="h-screen fixed flex flex-col gap-8 py-6 w-64 bg-gray-100 shadow-2xl">

          {/* Sidebar Header */}
          <div id="marketSidebarLogo" className="bg-green text-white p-4 px-1.5 shadow -me-2">
          ...
          <div id="marketSidebarBottomMenu" className="mt-auto flex flex-col gap-1 px-4 font-black text-gray-700">
            <div id="marketPersonalizedMessage" className="text-gray-400 text-xs text-center mb-3">
              <p>Welcome back, {session.user?.name ?? "Student"}</p>
            </div>
